    ...
    var _tab = {
        ...
        createTabDom: function () {
            ...
            var tpl = [
                    ...
                    '</ul>',
                    //'<div class="kit-tab-tool">页面操作&nbsp;<i class="fa fa-caret-down"></i></div>',
                    //'<div class="kit-tab-tool-body layui-anim layui-anim-upbit">',
                    //'<ul>',
                    //'<li class="kit-item" data-target="refresh"><i class="layui-icon">&#x1002;</i>刷新当前</li>',
                    //'<li class="kit-line"></li>',
                    //'<li class="kit-item" data-target="closeCurrent"><i class="layui-icon">&#x1006;</i>关闭当前</li>',
                    //'<li class="kit-line"></li>',
                    //'<li class="kit-item" data-target="closeOther"><i class="layui-icon">&#x1006;</i>关闭其他</li>',
                    //'<li class="kit-line"></li>',
                    //'<li class="kit-item" data-target="closeAll"><i class="layui-icon">&#x1006;</i>关闭所有</li>',
                    //'</ul>',
                    //'</div>',
                     '<ul class="layui-nav kit-nav mynav">',
                     '<li class="layui-nav-item">',
                     '<a href="javascript:void(0)">页面操作</a>',
                     '<dl class="layui-nav-child">',
                        '<dd data-target="refresh"><a href="javascript:void(0)"><i class="layui-icon">&#x1002;</i>刷新当前</a></dd>',
                        '<dd data-target="closeCurrent"><a href="javascript:void(0)"><i class="layui-icon">&#x1006;</i>关闭当前</a></dd>',
                        '<dd data-target="closeOther"><a href="javascript:void(0)"><i class="layui-icon">&#x1006;</i>关闭其他</a></dd>',
                        '<dd data-target="closeAll"><a href="javascript:void(0)"><i class="layui-icon">&#x1006;</i>关闭所有</a></dd>',
                    '</dl>',
                    '</li>',
                    '</ul>',
            ...
            that._title = $('.kit-tab ul.layui-tab-title');
            that._content = $('.kit-tab div.layui-tab-content');
            var _tool = $('.kit-tab-tool'), _toolBody = $('.mynav');
            //_toolBody = $('.kit-tab-tool-body');
            //监听操作点击事件
            _tool.on('click', function () {
                _toolBody.toggle();
            });
            //监听操作项点击事件li.kit-item
            _toolBody.find('dl dd').each(function () {
                var $that = $(this);
